...
export function useUsageData(): UseUsageDataReturn {
  ...
  const usageSnapshot = useUsageStatsStore((state: any) => state.usage);
  const loading = useUsageStatsStore((state: any) => state.loading);
  const storeError = useUsageStatsStore((state: any) => state.error);
  const lastRefreshedAtTs = useUsageStatsStore((state: any) => state.lastRefreshedAt);
  const loadUsageStats = useUsageStatsStore((state: any) => state.loadUsageStats);
